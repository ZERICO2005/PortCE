...
/* @cond */
#define os_CmdShadow         ((uint8_t*)RAM_ADDRESS(0xD0232D))
#define os_TextShadow        ((uint8_t*)RAM_ADDRESS(0xD006C0))
#define os_PromptRow         (*(uint8_t*)RAM_ADDRESS(0xD00800))
#define os_PromptCol         (*(uint8_t*)RAM_ADDRESS(0xD00801))
#define os_PromptIns         (*(uint8_t*)RAM_ADDRESS(0xD00802))
#define os_PromptShift       (*(uint8_t*)RAM_ADDRESS(0xD00803))
#define os_PromptRet         (*(uint8_t*)RAM_ADDRESS(0xD00804))
#define os_PromptValid       (*(uint8_t*)RAM_ADDRESS(0xD00807))
/* @endcond */

/** `uint8_t`: Font row position */
#define os_CurRow            (*(uint8_t*)RAM_ADDRESS(0xD00595))
/** `uint8_t`: Font column position */
#define os_CurCol            (*(uint8_t*)RAM_ADDRESS(0xD00596))
/** `uint16_t`: Large font foreground 565 BGR color */
#define os_TextFGColor       (*(uint16_t*)RAM_ADDRESS(0xD02688))
/** `uint16_t`: Large font background 565 BGR color */
#define os_TextBGColor       (*(uint16_t*)RAM_ADDRESS(0xD0268A))
/** `uint24_t`: Small font column position */
#define os_PenCol            (*(uint24_t*)RAM_ADDRESS(0xD008D2))
/** `uint8_t`: Small font row position */
#define os_PenRow            (*(uint8_t*)RAM_ADDRESS(0xD008D5))
 /** `uint16_t`: Small font background 565 BGR color */
#define os_DrawBGColor       (*(uint16_t*)RAM_ADDRESS(0xD026AA))
/** `uint16_t`: Small font foreground 565 BGR color */
#define os_DrawFGColor       (*(uint16_t*)RAM_ADDRESS(0xD026AC))
/** `uint8_t`: Small OS font color code */
#define os_DrawColorCode     (*(uint8_t*)RAM_ADDRESS(0xD026AE))
/** `uint16_t`: Graph background 565 BGR color */
#define os_GraphBGColor      (*(uint16_t*)RAM_ADDRESS(0xD02A98))
/** `uint16_t`: OS Rect draw 565 BGR color */
#define os_FillRectColor     (*(uint16_t*)RAM_ADDRESS(0xD02AC0))
