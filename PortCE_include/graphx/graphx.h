 ...
 * @param[in] height Height of rectangle.
 */
void gfx_FillRectangle(int24_t x,
                       int24_t y,
                       int24_t width,
                       int24_t height);
 ...
 */
void gfx_FillTriangle(int24_t x0,
                      int24_t y0,
                      int24_t x1,
                      int24_t y1,
                      int24_t x2,
 ...
 * @param[in] y2 Third Y coordinate.
 */
void gfx_FillTriangle_NoClip(int24_t x0,
                             int24_t y0,
                             int24_t x1,
                             int24_t y1,
                             int24_t x2,
