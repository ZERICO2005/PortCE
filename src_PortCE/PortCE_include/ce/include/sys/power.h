...
#define os_ApdFlags          (*(uint8_t*)RAM_ADDRESS(0xD00088))
#define os_ApdSubTimer       (*(uint8_t*)RAM_ADDRESS(0xD00590))
#define os_ApdTimer          (*(uint8_t*)RAM_ADDRESS(0xD00591))

#define os_BatteryStatus     (*(uint8_t*)RAM_ADDRESS(0xD02A86))
