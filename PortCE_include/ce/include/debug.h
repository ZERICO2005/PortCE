...
#define dbgout ((char*)RAM_ADDRESS(0xFB0000))
/** Standard error debug output */
#define dbgerr ((char*)RAM_ADDRESS(0xFC0000))
...
do { \
    *(volatile unsigned char*)RAM_ADDRESS(0xFFFFE0) = 10; \
} while (0)
...
#define dbg_Debugger() \
do { \
    *(volatile unsigned char*)RAM_ADDRESS(0xFFFFE0) = (unsigned char)~0; \
} while (0)
...
do { \
    *(volatile unsigned char*)RAM_ADDRESS(0xFFFFE0) = 5; \
} while (0)
...
do { \
    *(volatile unsigned char*)RAM_ADDRESS(0xFFFFE0) = 6; \
} while (0)
