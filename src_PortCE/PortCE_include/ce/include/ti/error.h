 ...
 *
 * @code{.cpp}
 * ti_int errno = os_PushErrorHandler();
 * if (errno) {
 ...
 */
ti_int os_PushErrorHandler(void) __attribute__((returns_twice));
 ...
 */
#define os_AppErr1           ((char*)RAM_ADDRESS(0xD025A9))
 ...
 * @note String must be null-terminated, maximum of 12 characters.
 */
#define os_AppErr2           ((char*)RAM_ADDRESS(0xD025B6))
