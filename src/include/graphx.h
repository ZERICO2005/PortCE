 ...
 */
typedef struct __attribute__((__packed__)) gfx_sprite_t {
 ...
 * <a href="https://github.com/mateoconlechuga/convimg" target="_blank">convimg</a>.
 */
typedef struct __attribute__((__packed__)) gfx_rletsprite_t {
    uint8_t width; /**< Width of the image. */
    uint8_t height; /**< Height of the image. */
    uint8_t data[]; /**< Image data array. */
} gfx_rletsprite_t;
 ...
 */
#define gfx_vbuffer \
(*((uint8_t(*)[240][320])RAM_ADDRESS(*(uint24_t*)RAM_ADDRESS(0xE30014))))
 ...
 * @param[in] y Y coordinate position.
 * @param[in] angle 256 position angular integer.
 * @see gfx_RotatedScaledSprite_NoClip.
 */
 ...
 * @param[in] y Y coordinate position.
 * @param[in] angle 256 position angular integer.
 * @see gfx_RotatedScaledSprite.
 */
#define gfx_RotatedSprite(sprite, x, y, angle) \
gfx_RotatedScaledSprite(sprite, x, y, angle, 64)
 ...
 * @param[in] y1 Second Y coordinate.
 */
void gfx_Line_NoClip(ti_uint x0,
                     uint8_t y0,
                     ti_uint x1,
                     uint8_t y1);
 ...
 * @param[in] length Length of line.
 */
void gfx_HorizLine_NoClip(ti_uint x,
                          uint8_t y,
                          ti_uint length);
 ...
 * @param[in] length Length of line.
 */
void gfx_VertLine_NoClip(ti_uint x,
                         uint8_t y,
                         ti_uint length);
 ...
 * @param[in] height Height of rectangle.
 */
void gfx_Rectangle_NoClip(ti_uint x,
                          uint8_t y,
                          ti_uint width,
                          uint8_t height);
 ...
 * @param[in] height Height of rectangle.
 */
void gfx_FillRectangle(ti_int x,
                       ti_int y,
                       ti_int width,
                       ti_int height);
 ...
 * @param[in] height Height of rectangle
 */
void gfx_FillRectangle_NoClip(ti_uint x,
                              uint8_t y,
                              ti_uint width,
                              uint8_t height);
 ...
 * @param[in] radius The radius of the circle.
 */
void gfx_FillCircle_NoClip(ti_uint x,
                           uint8_t y,
                           ti_uint radius);
 ...
 */
void gfx_FillEllipse_NoClip(ti_uint x, ti_uint y, uint8_t a, uint8_t b);
 ...
 * @param[in] b The vertical radius of the ellipse (current maximum is 128).
 */
void gfx_FillEllipse(ti_int x, ti_int y, ti_uint a, ti_uint b);
 ...
 * @param[in] b The vertical radius of the ellipse (current maximum is 128).
 */
void gfx_Ellipse_NoClip(ti_uint x, ti_uint y, uint8_t a, uint8_t b);
 ...
 * @param[in] b The vertical radius of the ellipse (current maximum is 128).
 */
void gfx_Ellipse(ti_int x, ti_int y, ti_uint a, ti_uint b);
 ...
 */
void gfx_FillTriangle(ti_int x0,
                      ti_int y0,
                      ti_int x1,
                      ti_int y1,
                      ti_int x2,
 ...
 * @param[in] y2 Third Y coordinate.
 */
void gfx_FillTriangle_NoClip(ti_int x0,
                             ti_int y0,
                             ti_int x1,
                             ti_int y1,
                             ti_int x2,
 ...
 * @param[in] y Y coordinate.
 */
void gfx_Sprite_NoClip(const gfx_sprite_t *sprite, ti_uint x, uint8_t y);
 ...
 * @param[in] y Y coordinate.
 */
void gfx_TransparentSprite_NoClip(const gfx_sprite_t *sprite, ti_uint x, uint8_t y);
 ...
 */
ti_uint gfx_GetStringWidth(const char *string) __attribute__((__pure__));
 ...
 * @note Takes into account monospacing flag.
 */
ti_uint gfx_GetCharWidth(const char c) __attribute__((__pure__));
