...
#define spi_StatusBits           ((const volatile void*)CONST_RAM_ADDRESS(0xF8000C))
#define spi_InterruptControl     ((volatile void*)RAM_ADDRESS(0xF80010))
#define spi_InterruptStatus      ((const volatile void*)CONST_RAM_ADDRESS(0xF80014))
#define spi_FIFO                 ((volatile void*)RAM_ADDRESS(0xF80018))
#define spi_InsideReservedRange  ((volatile void*)RAM_ADDRESS(0xF8001C))
#define spi_Revision             ((const volatile void*)CONST_RAM_ADDRESS(0xF80060))
#define spi_Features             (*(const volatile uint32_t*)CONST_RAM_ADDRESS(0xF80064))
/* @endcond */
