 ...
 */
#define timer_Enable(n, rate, int, dir) ((timer_Control = timer_Control & ~(0x7 << 3 * ((n) - 1) | 1 << ((n) + 8)) | (1 | (rate) << 1 | (int) << 2) << 3 * ((n) - 1) | (dir) << ((n) + 8)) | PortCE_update_registers())
 ...
 */
#define timer_Disable(n) ((timer_Control &= ~(1 << 3 * ((n) - 1))) | PortCE_update_registers())
...
#define timer_1_Counter          (*(volatile uint32_t*)RAM_ADDRESS(0xF20000))
#define timer_1_ReloadValue      (*(volatile uint32_t*)RAM_ADDRESS(0xF20004))
#define timer_1_MatchValue_1     (*(volatile uint32_t*)RAM_ADDRESS(0xF20008))
#define timer_1_MatchValue_2     (*(volatile uint32_t*)RAM_ADDRESS(0xF2000C))
#define timer_2_Counter          (*(volatile uint32_t*)RAM_ADDRESS(0xF20010))
#define timer_2_ReloadValue      (*(volatile uint32_t*)RAM_ADDRESS(0xF20014))
#define timer_2_MatchValue_1     (*(volatile uint32_t*)RAM_ADDRESS(0xF20018))
#define timer_2_MatchValue_2     (*(volatile uint32_t*)RAM_ADDRESS(0xF2001C))
#define timer_3_Counter          (*(volatile uint32_t*)RAM_ADDRESS(0xF20020))
#define timer_3_ReloadValue      (*(volatile uint32_t*)RAM_ADDRESS(0xF20024))
...
#define timer_IntStatus          (*(volatile uint16_t*)RAM_ADDRESS(0xF20034))
