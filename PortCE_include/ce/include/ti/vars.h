...
#define os_RamStart        ((uint8_t*)RAM_ADDRESS(0xD00000))

/** @see `<ti/flags.h>` */
#define os_RclFlags        (*(uint8_t*)RAM_ADDRESS(0xD0008E))

/** Generally unused by the OS. Type: `uint8_t[256]` */
#define os_AppData         ((uint8_t*)RAM_ADDRESS(0xD00429))

/* @cond */
#define os_ProgToEdit      ((char*)RAM_ADDRESS(0xD0065B))
#define os_NameBuff        ((char*)RAM_ADDRESS(0xD00663))
/* @endcond */

/** Current size of executing program. Type: `uint24_t` */
#define os_AsmPrgmSize     (*(uint24_t*)RAM_ADDRESS(0xD0118C))

/** Set after asm_ArcChk call. Type: `uint24_t` */
#define os_TempFreeArc     (*(uint24_t*)RAM_ADDRESS(0xD02655))
 ...
 */
int24_t os_DelSymEntry(void *entry);
 ...
 */
int24_t os_CreateString(const char *name, const string_t *data);
 ...
 */
string_t *os_GetStringData(const char *name, int24_t *archived);
 ...
 * @returns A TIOS error code, or 0 on success.
 */
int24_t os_CreateEquation(const char *name, const equ_t *data);
 ...
 */
equ_t *os_GetEquationData(const char *name, int24_t *archived);
 ...
 */
var_t *os_GetAppVarData(const char *name, int24_t *archived);
 ...
 */
int24_t os_ChkFindSym(uint8_t type, const char *name, void **entry, void **data);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_GetVarSize(const char *name, size_t *size);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_GetMatrixDims(const char *name, int24_t *rows, int24_t *cols);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_GetRealListElement(const char *name, int24_t index, real_t *value);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_GetMatrixElement(const char *name, int24_t row, int24_t col, real_t *value);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_GetRealVar(const char *name, real_t *value);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_SetListDim(const char *name, int24_t dim);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_SetMatrixDims(const char *name, int24_t rows, int24_t cols);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_SetRealListElement(const char *name, int24_t index, const real_t *value);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_SetMatrixElement(const char *name, int24_t row, int24_t col, const real_t *value);
 ...
 * @return TIOS System Error Code or 0 on success.
 */
int24_t os_SetRealVar(const char *name, const real_t *value);
 ...
 * @see os_RunPrgm
 */
typedef int24_t (*os_runprgm_callback_t)(void *data, int24_t retval);
 ...
 * or a shell).
 */
int24_t os_RunPrgm(const char *prgm, void *data, size_t size, os_runprgm_callback_t callback);
 ...
 * the Ans variable.
 */
int24_t os_Eval(const void *data, size_t len);
 ...
 * the Ans variable.
 */
int24_t os_EvalVar(const char *name);
