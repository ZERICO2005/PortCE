...
#define kb_EnableInt \
(*(uint8_t*)RAM_ADDRESS(0xF5000C))          /**< Enabled keypad interrupt signals. */
#define kb_IntAcknowledge \
(*(volatile uint8_t*)RAM_ADDRESS(0xF50008)) /**< Acknowledege keypad interrupt signals. */
#define kb_IntStatus \
(*(volatile uint8_t*)RAM_ADDRESS(0xF50008)) /**< Status of keypad interrupt signals. */
#define kb_Config \
(*(volatile uint8_t*)RAM_ADDRESS(0xF50000)) /**< Configuration of keypad controller. */
 ...
 */
#define kb_Data \
(uint8_t)((volatile uint16_t*)RAM_ADDRESS(0xF50010))
 ...
 */
#define kb_On \
(*(volatile uint8_t*)RAM_ADDRESS(0xF00020) & 1)
...
((*(volatile uint8_t*)RAM_ADDRESS(0xF0002C)) |= 1)
...
((*(volatile uint8_t*)RAM_ADDRESS(0xF00028)) = 1)
