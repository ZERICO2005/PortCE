...
#define os_KbdScanCode       (*(uint8_t*)RAM_ADDRESS(0xD00587))
/* @cond */
#define os_KbdLGSC           (*(uint8_t*)RAM_ADDRESS(0xD00588))
#define os_KbdPSC            (*(uint8_t*)RAM_ADDRESS(0xD00589))
#define os_KbdWUR            (*(uint8_t*)RAM_ADDRESS(0xD0058A))
#define os_KbdDebncCnt       (*(uint8_t*)RAM_ADDRESS(0xD0058B))
/* @endcond */
